          ...
          <footer className="footer">
            ...
            <section id="value">
              ...
              <a href={`mailto:${contactInfo.email}`}>
                ...
                <path d="M14 1.375C14 0.61875 13.37 0 12.6 0H1.4C0.63 0 0 0.61875 0 1.375V9.625C0 10.3813 0.63 11 1.4 11H12.6C13.37 11 14 10.3813 14 9.625V1.375ZM12.6 1.375L7 4.8125L1.4 1.375H12.6ZM12.6 9.625H1.4V2.75L7 6.1875L12.6 2.75V9.625Z" fill={darkMode?"white":"black"}/>
                </svg>
