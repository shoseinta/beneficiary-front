...
function Form1({
  ...
  const [selectedTypeLayerOne, setSelectedTypeLayerOne] = useState(
  ...
  const typeLayerOneSelection = (e) => {
    ...
    setRequestData((pre) => ({
      ...pre,
      beneficiary_request_type_layer1: Number(e.target.value),
  ...
  const handleTypeLayerTwoSelection = (event) => {
    ...
    const selectedItem = typeLayerTwo.find(
      (item) =>
        item.beneficiary_request_type_layer2_id.toString() === selectedId
    );
    setRequestData((pre) => ({
      ...pre,
      beneficiary_request_type_layer2:
        selectedItem.beneficiary_request_type_layer2_id,
    }));
  };
        ...
        <form className="form">
          <fieldset className="type-layer1 input-space">
            <legend className="label-space">
              {' '}
              نوع درخواست شما در کدامیک از دسته‌های زیر قرار دارد؟ <sup>*</sup>
            </legend>
            ...
            <div className="choice-group">
              <input
                ...
                checked={
                  selectedTypeLayerOne ===
                  typeLayerOne[0].beneficiary_request_type_layer1_id
                }
              ...
              <input
                ...
                checked={
                  selectedTypeLayerOne ===
                  typeLayerOne[1].beneficiary_request_type_layer1_id
                }
                onChange={typeLayerOneSelection}
              />
              ...
              <input
                ...
                checked={
                  selectedTypeLayerOne ===
                  typeLayerOne[2].beneficiary_request_type_layer1_id
                }
                onChange={typeLayerOneSelection}
              />
          ...
          <div className="type-layer2 input-space">
            <label htmlFor="type-layer2-id" className="label-space">
              {' '}
              {selectedTypeLayerOne === 1 &&
              ...
              {selectedTypeLayerOne === 3 &&
                'خدمت درخواستی شما در کدامیک از دسته های زیر قرار دارد؟'}
              {(selectedTypeLayerOne === 1 ||
                selectedTypeLayerOne === 2 ||
                selectedTypeLayerOne === 3) && <sup>*</sup>}
            </label>
            {selectedTypeLayerOne && (
              <select
                id="type-layer2-id"
              ...
              >
                ...
                {typeLayerTwo
                  .filter((element) => {
                    return (
                      element.beneficiary_request_type_layer1 ===
                      selectedTypeLayerOne
                    );
                  })
                  .map((item) => {
                    return (
                      <option value={item.beneficiary_request_type_layer2_id}>
